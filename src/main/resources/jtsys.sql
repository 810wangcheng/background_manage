...
CREATE TABLE `sys_logs` (
  ...
  `createdTime` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COMMENT='系统日志';
...
INSERT INTO `sys_logs` VALUES ('39', 'admin', 'operation', 'com.cy.service.SysRoleServiceImpl.findRolePageObjects', '[null, 1]', '36', '0:0:0:0:0:0:0:1', '2020-12-08 08:40:20');
INSERT INTO `sys_logs` VALUES ('40', 'admin', 'operation', 'com.cy.service.SysRoleServiceImpl.findRolePageObjects', '[null, 1]', '12', '0:0:0:0:0:0:0:1', '2020-12-08 08:40:42');
INSERT INTO `sys_logs` VALUES ('41', 'admin', 'operation', 'com.cy.service.SysRoleServiceImpl.saveOrUpdateRole', '[SystemRole(name=业务员, note=系统业务处理), [Ljava.lang.Integer;@32d36444]', '35', '0:0:0:0:0:0:0:1', '2020-12-08 08:41:23');
INSERT INTO `sys_logs` VALUES ('42', 'admin', 'operation', 'com.cy.service.SysRoleServiceImpl.findRolePageObjects', '[null, 1]', '8', '0:0:0:0:0:0:0:1', '2020-12-08 08:41:24');
...
INSERT INTO `sys_roles` VALUES ('46', '业务员', '系统业务处理', '2020-12-08 16:41:23', '2020-12-08 16:41:23', 'admin', 'admin');
...
CREATE TABLE `sys_role_menus` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1256 DEFAULT CHARSET=utf8 COMMENT='角色与菜单对应关系';
...
INSERT INTO `sys_role_menus` VALUES ('1250', '17', '1');
INSERT INTO `sys_role_menus` VALUES ('1251', '17', '45');
INSERT INTO `sys_role_menus` VALUES ('1252', '17', '1');
INSERT INTO `sys_role_menus` VALUES ('1253', '17', '45');
INSERT INTO `sys_role_menus` VALUES ('1254', null, '8');
INSERT INTO `sys_role_menus` VALUES ('1255', null, '25');
...
CREATE TABLE `sys_users` (
  ...
  `salt` varchar(100) DEFAULT NULL COMMENT '盐  密码加密时前缀，使加密后的值不同',
...
INSERT INTO `sys_users` VALUES ('17', 'itadmin', '9a43210e8d370ff6b291ea815aafb3e5', null, '1010101010@qq.com', '19869695555', '1', '2', '2020-11-14 16:51:03', '2020-11-15 01:53:21', 'admin', 'admin');
INSERT INTO `sys_users` VALUES ('18', '1', '230bc7f14b8e3db58023ce4b2cd88ff6', '2385be6a-0398-4563-bc95-c57baa499c54', '1010101011@qq.com', '19869696666', '1', '2', '2020-11-15 01:55:51', '2020-11-15 01:55:51', 'admin', 'admin');
...
INSERT INTO `sys_user_roles` VALUES ('70', '17', '1');
INSERT INTO `sys_user_roles` VALUES ('71', '17', '45');
